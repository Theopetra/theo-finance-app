...
interface TheopetraERC20TokenInterface extends ethers.utils.Interface {
  functions: {
...
export class TheopetraERC20Token extends BaseContract {
  ...
  interface: TheopetraERC20TokenInterface;
