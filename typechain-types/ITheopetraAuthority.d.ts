...
interface ITheopetraAuthorityInterface extends ethers.utils.Interface {
  functions: {
...
export class ITheopetraAuthority extends BaseContract {
  ...
  interface: ITheopetraAuthorityInterface;
