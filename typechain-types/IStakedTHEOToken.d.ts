...
interface IStakedTHEOTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IStakedTHEOToken extends BaseContract {
  ...
  interface: IStakedTHEOTokenInterface;
